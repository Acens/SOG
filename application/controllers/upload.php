...
//Set relative Path with CI Constant
        $this->setPath_img_upload_folder("img/logos/");
        $this->setPath_img_thumb_upload_folder("img/logos/thumbnails/");

        
//Delete img url
        $this->setDelete_img_url(base_url() . 'img/logos/delete');
 

//Set url img with Base_url()
        $this->setPath_url_img_upload_folder(base_url() . "img/logos/");
        $this->setPath_url_img_thumb_upload_folder(base_url() . "img/logos/thumbnails/");
  }
